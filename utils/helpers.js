const covid = require('../controllers/covid19');
...
function receivedPostback(event) {
  ...
  sendTextMessage(senderID, "Hi! Kindly send hi to get updated with #Covid19");
}
...
function sendCovidActive(recipientId) {

  covid.fetch_active('philippines', (latest) => {
    var messageData = {
      recipient: {
        id: recipientId
      },
      message: {
        text: `${latest.Status} covid cases:  ${latest.Cases}`
      }
    };
